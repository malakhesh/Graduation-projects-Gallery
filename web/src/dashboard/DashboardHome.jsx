        ...
        >
          <span
            style={{
              ...
              textShadow:
                "0 0 14px rgba(255,215,0,0.6), 0 1px 3px rgba(100,60,0,0.4)",
            }}
          >
            Welcome
          </span>
...
export default function DashboardHome() {
  ...
  const getBoxStyle = (id, baseColor) => ({
    ...
    maxWidth: "none",
    backgroundColor:
      hoveredBox === id ? lightenColor(baseColor) + "ee" : baseColor + "cc",
  ...
  const slices = [
    {
      ...
      count: 10,
      color: "#6F4E37",
      path: "M70,70 L70,10 A60,60 0 0,1 122,100 Z",
      labelX: 92,
      labelY: 42,
      countX: 107,
      countY: 54,
    },
    {
      ...
      count: 6,
      color: "#a0714f",
      path: "M70,70 L122,100 A60,60 0 0,1 18,100 Z",
      labelX: 70,
      labelY: 112,
      countX: 70,
      countY: 124,
    },
    {
      ...
      count: 4,
      color: "#d2a679",
      path: "M70,70 L18,100 A60,60 0 0,1 70,10 Z",
      labelX: 32,
      labelY: 42,
      countX: 32,
      countY: 54,
  ...
  return (
    ...
    >
      ...
      >
            ...
            {["HOME", "PROFILE", "TEAM", "SETTINGS"].map((item) => (
              <li
                ...
                style={{
                  ...
                  borderRadius: "8px",
                  backgroundColor:
                    hoveredNav === item ? "#e8d5bf" : "transparent",
                  transform:
                    hoveredNav === item
        ...
        <div>
          <div
            style={{ marginTop: "20px", textAlign: "center", color: "#5C4033" }}
          >
            <span
              ...
              style={{
                ...
                transform: hoveredSignIn
                  ? "translateX(6px) scale(1.02)"
                  : "translateX(0) scale(1)",
                boxShadow: hoveredSignIn
                  ? "0 4px 12px rgba(0,0,0,0.15)"
                  : "none",
                    ...
                    <path
                      ...
                      transform={
                        hoveredSlice === slice.id
                          ? `translate(${
                              slice.id === "web" ? 4 : slice.id === "ai" ? 0 : -4
                            },${
                              slice.id === "web" ? -4 : slice.id === "ai" ? 4 : -4
                            })`
                          : "translate(0,0)"
                      }
