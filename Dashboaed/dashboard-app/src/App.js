...
function AppLayout() {
  ...
  const getBoxStyle = (id, baseColor) => ({
    ...
    minWidth: 0,
    maxWidth: "none",
    backgroundColor: hoveredBox === id ? lightenColor(baseColor) : baseColor,
    borderRadius: "10px",
  ...
  return (
    <div style={{ display: "flex", height: "100vh", fontFamily: "'Poppins', sans-serif" }}>
          ...
          <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: "55px" }}>
            {["Dashboard", "Profile", "Team", "Settings"].map((item) => (
              <li key={item}
                ...
                style={{
                  marginBottom: "0", padding: "8px 10px",
                  borderBottom: "1px solid #ccc", cursor: "pointer", color: "#6F4E37",
                  borderRadius: "8px",
      ...
      <main style={{
        display: "flex", flexDirection: "row", marginLeft: "200px",
        backgroundColor: "transparent", padding: "30px 60px", gap: "30px",
        height: "100vh", alignItems: "center", boxSizing: "border-box",
        ...
        >
          ...
          <div>
            <div style={{ width: "100%", backgroundColor: "#c8a882", borderRadius: "10px", height: "8px", overflow: "hidden" }}>
              <div style={{ width: "60%", backgroundColor: "#6F4E37", height: "100%", borderRadius: "10px", transition: "width 0.5s ease" }}></div>
            </div>
        ...
        >
          ...
          <div>
            <div style={{ width: "100%", backgroundColor: "#b89868", borderRadius: "10px", height: "8px", overflow: "hidden" }}>
              <div style={{ width: "10%", backgroundColor: "#5C4033", height: "100%", borderRadius: "10px", transition: "width 0.5s ease" }}></div>
            </div>
            ...
            <svg width="170" height="170" viewBox="0 0 140 140">
              {slices.map((slice) => (
                ...
                >
                  ...
                  />
                  <text x={slice.labelX} y={slice.labelY} textAnchor="middle" fill="white" fontSize="9" fontWeight="bold" style={{ pointerEvents: "none" }}>
                    {slice.percent}
                  </text>
                  <text x={slice.countX} y={slice.countY} textAnchor="middle" fill="white" fontSize="8" style={{ pointerEvents: "none" }}>
                    {slice.count} projects
                  </text>
                </g>
              ))}
