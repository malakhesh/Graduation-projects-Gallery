...
type ProjectDetailsModalContentProps = {
  projectId?: string | null;
  onClose: () => void;
};

export default function ProjectDetailsModalContent({
  projectId,
  onClose,
}: ProjectDetailsModalContentProps) {
  ...
  if (error) {
    return (
      <SafeAreaView style={styles.center}>
        ...
        <TouchableOpacity style={styles.errorBackButton} onPress={onClose}>
