...
export default function UploadProjectModal({
  ...
  const fillEditForm = () => {
    ...
    const oldTags = Array.isArray(projectToEdit.tags)
      ? projectToEdit.tags
      : [];

    const oldStack = Array.isArray(projectToEdit.stack)
      ? projectToEdit.stack
      : [];

    const oldImage = projectToEdit.imgUrl || projectToEdit.image || null;

    setStep(0);
    setName(projectToEdit.title || projectToEdit.name || "");
    setDescription(projectToEdit.desc || projectToEdit.description || "");
    setGithub(projectToEdit.gitLink || projectToEdit.github || "");
    setTag(oldTags.length > 0 ? oldTags[0] : "");
  ...
  const validateStep = (currentStep: number): Record<string, string> => {
    ...
    if (currentStep === 0) {
      ...
      if (!github.trim()) {
        ...
        newErrors.github =
          "🌸 Please enter a valid GitHub link (starts with https://github.com/)";
      }
    }
  ...
  const updateExistingProject = async (imgUrl: string) => {
    const projectId = getProjectIdForEdit();
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (isEditMode) {
        imgUrl = projectToEdit?.imgUrl || projectToEdit?.image || "";

        if (imageChanged && imageUri) {
          Toast.show({
            type: "info",
            text1: "📸 Uploading new image...",
            text2: "Please wait ✨",
            position: "top",
            visibilityTime: 2000,
          });
      ...
      if (!currentUser) {
        Toast.show({
          ...
          text1: "❌ Not logged in",
          text2: isEditMode
            ? "Please login to edit this project"
      ...
      if (isEditMode) {
        result = await updateExistingProject(imgUrl);
      } else {
      ...
      if (result === "add-fail" || result === "update-fail") {
        setErrors({
          submit: isEditMode
        ...
        Toast.show({
          type: "error",
          text1: isEditMode ? "❌ Save failed" : "❌ Upload failed",
      ...
      Toast.show({
        type: "success",
        text1: isEditMode ? "✅ Changes saved!" : "🎉 Project submitted!",
        text2: isEditMode
          ? "Your project was updated and sent for review."
          ...
          <View style={{ alignItems: "center", width: 64 }}>
            ...
            <Text
              style={{
                fontSize: 10,
                marginTop: 4,
                color: idx === step ? COLORS.button : COLORS.link,
          ...
          {idx < STEPS.length - 1 && (
            <View
              style={{
                flex: 1,
                height: 2,
                backgroundColor: idx < step ? COLORS.button : COLORS.border,
              }}
            />
          )}
        </React.Fragment>
    ...
    <>
      ...
      >
        <View
          style={{
            flex: 1,
            backgroundColor: "rgba(30,16,6,0.6)",
            justifyContent: "center",
            alignItems: "center",
            padding: 20,
          }}
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  {isEditMode ? "✏️ Edit Project" : "✨ Upload Project"}
                </Text>
              ...
              >
                {success ? (
                  ...
                  >
                    ...
                    >
                      {isEditMode ? "Changes saved!" : "Project submitted!"}
                    </Text>
                        ...
                        <View>
                          ...
                          <TextInput
                            style={{
                              ...
                              borderColor: errors.github
                                ? COLORS.error
                                : isValidGithubLink(github) && github
                                ? COLORS.button
                                : "transparent",
                            }}
                          ...
                          {errors.github ? (
                            ...
                            >
                              ...
                              <View style={{ flex: 1 }}>
                                ...
                                >
                                  Pretty please, enter a valid GitHub URL like:
                            ...
                            >
                              ...
                              <View style={{ flex: 1 }}>
                                ...
                                >
                                  Yay! Your GitHub repository link is valid! 💻
                                </Text>
                              </View>
                            </View>
                          ) : github.trim() !== "" &&
                            ...
                            >
                              ...
                              <View style={{ flex: 1 }}>
                                ...
                                >
                                  GitHub links start with https://github.com/ —
                                  please double-check! 🌸
                                </Text>
                              </View>
                            </View>
                      ...
                      <View style={{ gap: 20 }}>
                          ...
                          >
                            {TAGS.map((t) => (
                              <TouchableOpacity
                                ...
                                style={{
                                  backgroundColor:
                                    tag === t ? COLORS.button : COLORS.chip,
                                  borderRadius: 25,
                        ...
                        <View>
                          ...
                          >
                            ...
                            {techStack.length > 0 && (
                              <Text
                                style={{ color: COLORS.link, fontSize: 11 }}
                              >
                                {" "}
                    ...
                    {step === 2 && (
                      <View style={{ gap: 20 }}>
                        <View>
                          ...
                          {isEditMode && !imageChanged && imageUri ? (
                            <Text
                              style={{
                                color: COLORS.link,
                                fontSize: 11,
